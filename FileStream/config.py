...
class Telegram:
    API_ID = int(env.get("API_ID","21204722"))
    API_HASH = str(env.get("API_HASH","4f5b4bbc15e7f9df9961ac92e8fd219b"))
    ...
    MULTI_CLIENT = False
    FLOG_CHANNEL = int(env.get("FLOG_CHANNEL", "-1001946514305"))   # Logs channel for file logs
    ULOG_CHANNEL = int(env.get("ULOG_CHANNEL", "-1001987678822"))   # Logs channel for user logs
